            ...
            <div class="card-body"  style='overflow-x:scroll'>
              <table id="example1" class="table table-bordered table-striped">
			   ...
			   if(isset($_GET['ordercode'])){
				...
				$sales6 ="SELECT OrderCode,ProductName,Quantity,OrderDate,OrderStatus,StatusDate,SuppliedBy,OrderBy,OrderByEmail,OrderByPhone,IDDesc,RequestedDelivery,OrderCost,PaymentStatus,PaymentMethod FROM `orders` where OrderCode='".$_GET['ordercode']."' order by IDDesc Desc";
				$result5=mysqli_query($link,$sales6);
				$counter1=1;
				while($row5=mysqli_fetch_assoc($result5)){
                 echo"<tr>";
				 echo "<td>".$row5['OrderCode']."</td>";
                ...
                echo"</tr>";
						...
						require_once('../../Connection/connect.php');
				$sales6 ="SELECT OrderCode,ProductName,Quantity,OrderDate,OrderStatus,StatusDate,SuppliedBy,OrderBy,OrderByEmail,OrderByPhone,IDDesc,RequestedDelivery,OrderCost,PaymentStatus,PaymentMethod FROM `orders` order by IDDesc Desc";
				$result5=mysqli_query($link,$sales6);
				$counter1=1;
				while($row5=mysqli_fetch_assoc($result5)){
                 echo"<tr>";
