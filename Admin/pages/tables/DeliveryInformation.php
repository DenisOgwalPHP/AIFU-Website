...
<head>
  ...
  <title>AIFU | Delivery Information </title>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Delivery Information Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body"  style='overflow-x:scroll'>
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				...
				$sales6 ="SELECT * FROM `deliveryinformation` order by IDDesc Desc";
				...
				while($row5=mysqli_fetch_assoc($result5)){
				 ...
				 echo "<td>".$row5['State']."</td>";
				 echo "<td>".$row5['Town']."</td>";
				 echo "<td>".$row5['StreetAddress']."</td>";
				 echo "<td>".$row5['PostCode']."</td>";
				 echo "<td>".$row5['CompanyName']."</td>";
				  $id=$row5['IDDesc'];
				 echo'<td><form method="get" ><a href="DeliveryInformation.php"><button type="submit" name="delete"  value="'.$id.'" class="btn btn-block btn-danger">Delete</button></a></form></td>'; 
				...
				if(isset($_GET['delete'])){
					$id=$_GET['delete'];	
                        if(isset($id)){
				$sales6 ="DELETE  FROM deliveryinformation WHERE IDDesc='".$id."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("Delivery Information Record successfully Deleted");';
				echo'window.location.href="DeliveryInformation.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("Delivery Information Record Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="DeliveryInformation.php";';
				echo '</script>';
								}
