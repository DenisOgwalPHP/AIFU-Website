        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Testimonies Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body"  style='overflow-x:scroll'>
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				...
				$sales6 ="SELECT * FROM `testmonials` order by IDs Desc";
				$result5=mysqli_query($link,$sales6);
				$counter1=1;
				while($row5=mysqli_fetch_assoc($result5)){
                 echo"<tr>";
				 echo "<td>".$row5['Date']."</td>";
				 echo "<td>".$row5['Names']."</td>";
                 echo "<td>".$row5['Email']."</td>";
				 echo "<td>".$row5['PhoneNumber']."</td>";
				 echo "<td style='text-align:justify;text-justify:inter-word;'>".$row5['ShotDescription']."</td>";
				  $id=$row5['IDs'];
				 echo'<td><form method="get" ><a href="Testimonies.php"><button type="submit" name="delete"  value="'.$id.'" class="btn btn-block btn-danger">Delete</button></a></form></td>';  
                echo"</tr>";
				}
				?>
				<?php
				if(isset($_GET['delete'])){
					$id=$_GET['delete'];	
                        if(isset($id)){
				$sales6 ="DELETE  FROM testimonials WHERE IDs='".$id."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("Testimony successfully Deleted");';
				echo'window.location.href="Testimonies.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("Testimony Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="Testimonies.php";';
				echo '</script>';
								}
