...
<head>
  ...
  <title>AIFU | Blog Comment Replies </title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Blog Comment Replies</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../Dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Blog Comment Replies</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card" style='overflow-x:scroll'>
            <div class="card-header">
              <h3 class="card-title">Blog Comment Replies Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				...
				$sales6 ="SELECT replies.*,comments.IDs,comments.Comment FROM comments,replies where replies.CommentID=comments.IDs order by replies.IDs Desc";
				$result5=mysqli_query($link,$sales6);
				$counter1=1;
				while($row5=mysqli_fetch_assoc($result5)){
                 echo"<tr>";
				 echo "<td>".$row5['Date']."</td>";
				 echo "<td>".$row5['Reply']."</td>";
                 echo "<td>".$row5['ReplyBy']."</td>";
				 echo "<td>".$row5['Comment']."</td>";
				  $id=$row5['IDs'];
				 echo'<td><form method="get" ><a href="CommentReplies.php"><button type="submit" name="delete"  value="'.$id.'" class="btn btn-block btn-danger">Delete</button></a></form></td>';  
                echo"</tr>";
				}
				?>
				<?php
				if(isset($_GET['delete'])){
					$id=$_GET['delete'];	
                        if(isset($id)){
				$sales6 ="DELETE  FROM replies WHERE IDs='".$id."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("Reply successfully Deleted");';
				echo'window.location.href="CommentReplies.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("Reply Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="CommentReplies.php";';
				echo '</script>';
								}
