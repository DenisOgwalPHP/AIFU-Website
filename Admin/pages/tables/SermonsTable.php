        ...
        <div class="col-12">
          ...
          <div class="card" style='overflow-x:scroll'>
            <div class="card-header">
              <h3 class="card-title">Sermon Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				...
				$sales6 ="SELECT * FROM `sermons` order by IDs Desc";
				...
				while($row5=mysqli_fetch_assoc($result5)){
				 ...
				 echo "<td>".$row5['postedby']."</td>";
				  $id=$row5['IDs'];
				 echo'<td><form method="get" ><a href="SermonsTable.php"><button type="submit" name="delete"  value="'.$id.'" class="btn btn-block btn-danger">Delete</button></a></form></td>';  
                echo"</tr>";
				}
				?>
				<?php
				if(isset($_GET['delete'])){
					$id=$_GET['delete'];	
                        if(isset($id)){
				$sales6 ="DELETE  FROM sermons WHERE IDs='".$id."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("Sermon successfully Deleted");';
				echo'window.location.href="SermonsTable.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("Sermon Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="SermonsTable.php";';
				echo '</script>';
								}
