        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Volunteers Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body"  style='overflow-x:scroll'>
              <table id="example1" class="table table-bordered table-striped">
				...
				<tr>
				  ...
				  <th>CV</th>
				  <th>Ist Recomendation</th>
				  <th>2nd Recomendation</th>
				   <th> </th> 
                </tr>
				</thead>
               <?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT * FROM `volunteers` order by IDs Desc";
				$result5=mysqli_query($link,$sales6);
				$counter1=1;
				while($row5=mysqli_fetch_assoc($result5)){
                 echo"<tr>";
				 echo "<td>".$row5['FirstName']."</td>";
				 echo "<td>".$row5['LastName']."</td>";
				 echo "<td>".$row5['Email']."</td>";
                 echo "<td>".$row5['Phones']."</td>";
				 echo "<td>".$row5['Company']."</td>";
				 echo "<td>".$row5['Continent']."</td>";
				 echo "<td>".$row5['Country']."</td>";
				 echo "<td>".$row5['Region']."</td>";
				 echo "<td>".$row5['Town']."</td>";
				 echo "<td>".$row5['Address']."</td>";
				 echo "<td>".$row5['PostCode']."</td>";
				  $id=$row5['IDs'];
				  $ids=$row5['Approved'];
				
				  if($ids=="Approved"){
				 echo "<td>".$row5['Approved']."</td>";
				  }else{
					  
					 echo'<td><form method="get" ><a href="Volunteers.php"><button type="submit" name="approve"  value="'.$id.'" class="btn btn-block btn-primary">Approve</button></a></form></td>';    
				  }
				  echo "<td><a href='../../../CVS/".$row5['CV']."'>".$row5['CV']."</a></td>";
				    echo "<td><a href='../../../Recommendations/".$row5['reco1']."'>".$row5['reco1']."</a></td>";
					  echo "<td><a href='../../../Recommendations2/".$row5['reco2']."'>".$row5['reco2']."</a></td>";
				 
				 echo'<td><form method="get" ><a href="Volunteers.php"><button type="submit" name="delete"  value="'.$id.'" class="btn btn-block btn-danger">Delete</button></a></form></td>';  
                echo"</tr>";
				}
				?>
				<?php
				if(isset($_GET['delete'])){
					$id=$_GET['delete'];	
                        if(isset($id)){
				$sales6 ="DELETE  FROM volunteers WHERE IDs='".$id."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("Volunteer successfully Deleted");';
				echo'window.location.href="Volunteers.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("Volunteer Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="Volunteers.php";';
				echo '</script>';
								}
				...
				$id=$_GET['approve'];
				if(isset($id)){
				$sales6 ="UPDATE volunteers SET Approved='Approved' WHERE IDs='".$id."'";
				$result=mysqli_query($link,$sales6);
				if($result){
					echo '<script type="application/javascript">';
