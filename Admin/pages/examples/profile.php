          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo $_SESSION['aifuadminuser'];?></h3>
				<p class="text-muted text-center"><?php echo $_SESSION['aifuadminemail'];?></p>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <?php
				  ...
				  $emails=$_SESSION['aifuadminemail'];
                  ...
                  <div class="active tab-pane" id="settings">
                    <form class="form-horizontal" method="Post" action="updatemyprofile.php">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputEmail" name="inputEmail"  Value="<?php echo $_SESSION['aifuadminemail'];?>" placeholder=" Enter Email" readonly>
                        </div>
                      </div>
					  <div class="form-group">
