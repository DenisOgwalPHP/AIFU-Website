...
<head>
  ...
  <title>AIFU | Sermon Registration </title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Sermon Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
			    <form action="insertsermon.php" method="post" enctype="multipart/form-data">
			   <div class="form-group">
                    <label for="exampleInputEmail1">Sermon Title</label>
					<input class="form-control" type="text" name= "productname" placeholder="Enter Sermon Title" required>
               </div>
			    <div class="form-group">
			   ...
			   <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3"  name="description" placeholder="Enter Sermon short description of about 300 words" required></textarea>
               </div>
			   <div class="form-group">
				&nbsp; &nbsp;
            ...
            <div class="card card-info">
             ...
             <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				$sales6 ="SELECT Topic,postedby,Date FROM `sermons` order by Ids Desc LIMIT 10";
