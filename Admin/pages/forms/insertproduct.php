...
// getting inputs from the form	
	...
	require_once('../../Connection/connect.php');
	        ...
	        $query = "INSERT INTO `productdetails` (ProductName,Supplier,Category,Cost,Description,ProductImage,ShortDescription,ProductImage1,ProductImage2,Author,PublicationDate,ProductImage3) VALUES('$productname','$supplier','$category','$cost','$description','$newfilename','$shortdescription','$newfilename1','$newfilename2','$authors','$publicationdates','$newfilename3')";
