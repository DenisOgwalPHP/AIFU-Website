...
<div class="wrapper">
 ...
 <!-- SidebarSearch Form -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
			  ...
			  <li class="nav-item">
			   ...
			   <li class="nav-item">
                <a href="pages/forms/Sermon.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Sermons</p>
                </a>
              </li>
		  ...
		  <li class="nav-item has-treeview">
			...
			<li class="nav-item">
			    ...
			    <li class="nav-item">
                <a href="pages/tables/Bookings.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Bookings</p>
                </a>
              </li>
			   <li class="nav-item">
                <a href="pages/tables/DeliveryInformation.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
             ...
             <li class="nav-item">
			   ...
			   <li class="nav-item">
                <a href="pages/tables/Subscriptions.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Subscriptions</p>
                </a>
              </li>
			   <li class="nav-item">
                <a href="pages/tables/Donations.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Donations</p>
                </a>
              </li>
			   <li class="nav-item">
                <a href="pages/tables/Volunteers.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Volunteers</p>
                </a>
              </li>
			   <li class="nav-item">
                <a href="pages/tables/SermonsTable.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Sermons</p>
                </a>
              </li>
			   <li class="nav-item">
                <a href="pages/tables/Testimonies.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Testimonies</p>
                </a>
              </li>
			  <li class="nav-item">
			   ...
			   <li class="nav-item">
                <a href="pages/tables/BlogCommentsTable.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Blog Comments</p>
                </a>
              </li>
			   <li class="nav-item">
                <a href="pages/tables/CommentReplies.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Comment Replies</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="http://cropprotection.com">AIFU</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
