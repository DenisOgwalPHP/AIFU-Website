...
<body>
<?php 
if(isset($_SESSION['checkshop'])){
	if(isset($_GET['pesapal_transaction_tracking_id'])){
	$transactionid = $_GET['pesapal_transaction_tracking_id'];
	$referencenumber = $_GET['pesapal_merchant_reference'];
	require_once('connect.php');
	$query = "Update`orders` Set PaymentStatus='Paid' where OrderCode='".$referencenumber."'";
	$results=mysqli_query($link,$query);
	}		
}else if(isset($_SESSION['checkdonation'])){
	if(isset($_GET['pesapal_transaction_tracking_id'])){
	$transactionid = $_GET['pesapal_transaction_tracking_id'];
	$referencenumber = $_GET['pesapal_merchant_reference'];
	require_once('connect.php');
	$query = "Update`donate` Set Payment='Paid' where IDs='".$referencenumber."'";
	$results=mysqli_query($link,$query);
	}
}else if(isset($_SESSION['checksubscription'])){
	if(isset($_GET['pesapal_transaction_tracking_id'])){
	$transactionid = $_GET['pesapal_transaction_tracking_id'];
	$referencenumber = $_GET['pesapal_merchant_reference'];
	require_once('connect.php');
	$query = "Update`subscriptions` Set Payment='Paid' where IDs='".$referencenumber."'";
	$results=mysqli_query($link,$query);
	}
}
?>
                ...
                <div class="uni-banner-default uni-background-1">
                    <div class="container">
                        ...
                        <ul class="breadcrumbs">
                            <li><a href="index.php">home</a></li>
                            <li><a href="typography.php">Thank you</a></li>
                        </ul>
                        <!-- End breadcrumbs -->
                    </div>
                </div>
                        ...
                        <div class="uni-typography-text-alight-default">
                            <div class="text-align-center">
                                <h3 class="text-uppercase">Thank you</h3>
                                 <div class="uni-block-quote-default">
                                <blockquote>
                                    <p>
                                        Thank you, your receipt of payment has been sent to your email.
                                    </p>
                                    <cite>
