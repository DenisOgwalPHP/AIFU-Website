													...
													<div class="entry-content">
														<div class="woocommerce">
															<div class="woocommerce-info">
																<?php
																if ($_SESSION['aifuuser'] == "Guest") {
																	echo "<i class='fa fa-info-circle' aria-hidden='true'></i> Returning customer
                                                            <a href='#' class='showcoupon click-here-to-login'>Click here to login </a>";
																} else {
																	echo "<i class='fa fa-info-circle' aria-hidden='true'></i> Your Logged In as
                                                            <a href='#' class='showcoupon click-here-to-login'>" . $_SESSION['aifuuser'] . " </a>";
																} ?>
															</div>
															<div class="vk-form-woo-login">
																<div class="row">
																	<form class="woocomerce-form woocommerce-form-login login" method="post" action="login.php">
																		<div class="col-md-12">
																		...
																		<div class="col-md-6">
																			<p class="form-row form-row-first">
																				<input type="Email" class="input-text" name="email" id="nameemail" placeholder="Email...">
																			</p>
																		</div>
																		<div class="col-md-6">
																			<p class="form-row form-row-last">
																				<input class="input-text" type="password" name="passwords" id="passwords" placeholder="Password">
																			</p>
																		</div>
																		<input type="hidden" name="ordercodes" id="ordercodes" value="<?php
																																	require_once('connect.php');
																																	$sales6 = "SELECT OrderCode FROM `orders` where OrderByEmail='" . $_SESSION['aifuemail'] . "' and ReviewOrder ='Not Confirmed' order by IDDesc Asc ";
																				...
																				<div class="row">
																					<div class="col-md-9">
																						<p class="form-row">
																							...
																							<input type="submit" class="button" name="logins" value="LOGIN">
															...
															<div class="woocommerce-info">
																...
																<a href="#" class="showcoupon click-here-entry-code">Click here to enter your code </a>
															</div>
																...
																<div class="vk-checkout-billing-left">
																	<div class="col-md-6">
																		<div class="woocommerce-billing-fields">
																			...
																			<div class="woocommerce-billing-fields__field-wrapper">
																				...
																				<p class="form-row form-row-last validate-required" id="billing_ordernote_field" data-priority="20">
																					...
																					<input type="hidden" name="ordercode" id="ordercode" value="<?php
																																				require_once('connect.php');
																																				$sales6 = "SELECT OrderCode FROM `orders` where OrderByEmail='" . $_SESSION['aifuemail'] . "' and ReviewOrder ='Not Confirmed' order by IDDesc Asc ";
																																				$result5 = mysqli_query($link, $sales6);
																																				if (mysqli_num_rows($result5) >= 1) {
																		...
																		<div class="vk-checkout-creat-account">
																			<h3>
																				<input  type="checkbox" class="input-radio checkbox-create-account" name="payment_method" id="payment_method" value="cheque" data-order_button_text="">
																			...
																			<div class="vk-check-create-account-form checkbox-create-account-form">
																				...
																				<p class="form-row form-row-first">
																					...
																					<input type="password" class="input-text" name="passwords" id="passwords" placeholder="">
																				</p>
																				<div class="clearfix"></div>
																			...
																			<div id="order_review" class="woocommerce-checkout-review-order">
																					...
																					<table class="shop_table woocommerce-checkout-review-order-table">
																						...
																						<tbody>
																							...
																							if (isset($_SESSION['aifuuser'])) {
																								...
																								require_once('connect.php');
																								$sales7 = "SELECT ProductName,Quantity,OrderCost,IDDesc FROM `orders`  where OrderByEmail='" . $_SESSION['aifuemail'] . "' and OrderCode='" . $ordercodes . "' and ReviewOrder ='Not Confirmed' order by IDDesc ASC ";
																								$result8 = mysqli_query($link, $sales7);
																								while ($row8 = mysqli_fetch_assoc($result8)) {
																									echo "<tr class='cart_item'>";
																									echo "<td class='product-name'>" . $row8['ProductName'] . "</td>";
																									echo "<td class='product-total'>";
																									echo "<span class='woocommerce-Price-amount amount'><span class='woocommerce-Price-currencySymbol'>Shs.</span>" . ($row8['OrderCost']) . "</span></td>";
																									echo "</tr>";
																								}
																							}
																							?>
																						...
																						<tfoot>
																							...
																							<tr class="cart-subtotal">
																								<th>Subtotal</th>
																								<th><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">UGX.</span><?php
																																																			...
																																																			if (isset($_SESSION['aifuuser'])) {
																																																				...
																																																				require_once('connect.php');
																																																				$sales11 = "SELECT SUM(OrderCost) as Carttotal from orders where OrderByEmail='" . $_SESSION['aifuemail'] . "' and OrderCode='" . $ordercodes . "'";
																							...
																							<tr class="order-total">
																								<th>Total</th>
																								<th><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">USD.&nbsp;&nbsp;</span><?php
																																																					if (isset($_SESSION['aifuuser'])) {
																																																						$ordercodes = "";
																																																						require_once('connect.php');
																																																						$sales6 = "SELECT OrderCode FROM `orders` where OrderByEmail='" . $_SESSION['aifuemail'] . "' and ReviewOrder ='Not Confirmed' order by IDDesc Asc ";
																																																						...
																																																						if ($results) {
																																																							if ($row9 = mysqli_fetch_assoc($results)) {
																																																								$finalval =round((($row9['Carttotal']+0)/3600),2);
																																																								$finalval =round((($row9['Carttotal']+0)/3600));
																																																								echo '<input type="number" class="input-text" Value="'.$finalval.'" name="amounts" id="amounts" placeholder="">';
																																																								//echo "" . ($row9['Carttotal'] + 0);
																																																							} else {
																																																								echo '<input type="number" class="input-text" Value="0" name="amounts" id="amounts" placeholder="">';
																																																							}
																																																						} else {
																																																							echo '<input type="number" class="input-text" Value="0" name="amounts" id="amounts" placeholder="">';
																																																						}
																				...
																				<div id="payment" class="woocommerce-checkout-payment">
																					...
																					<div id="paypalbutton" class="form-row place-order">
																						...
																						<input type="hidden" name="totalcost" value="<?php if (isset($_SESSION['aifuuser'])) {
																																			$ordercodes = "";
																																			require_once('connect.php');
																																			$sales6 = "SELECT OrderCode FROM `orders` where OrderByEmail='" . $_SESSION['aifuemail'] . "' and ReviewOrder ='Not Confirmed'order by IDDesc Asc ";
																																			$result5 = mysqli_query($link, $sales6);
		...
		paypal.Buttons({
			...
			createOrder: function(data, actions) {
				return actions.order.create({
					purchase_units: [{
						amount: {
							value: document.getElementById("amounts").value,
							currency_code: "USD"
						}
			...
			onApprove: function(data, actions) {
				return actions.order.capture().then(function(details) {
					window.location = "insertcheckout.php?orderID=" + data.orderID + "&email=" + document.getElementById("email").value + "&first_name=" + document.getElementById("first_name").value + "&last_name=" + document.getElementById("last_name").value + "&address=" + document.getElementById("address").value + "&postcode=" + document.getElementById("postcode").value + "&totalcost=" + details.purchase_units[0].amount.value + "&country=" + document.getElementById("country").value + "&town_city=" + document.getElementById("town_city").value + "&notes=" + document.getElementById("notes").value + "&phone=" + document.getElementById("phone").value + "&company=" + document.getElementById("company").value + "&ordercode=" + document.getElementById("ordercode").value + "&passwords=" + document.getElementById("passwords").value + "&payment_method=" + document.getElementById("payment_method").value;
