                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="uni-main-menu">
									...
									<li class="has-sub"><a style="background:#3f97da;" href="about.php">About</a>
									<ul>
											<li><a href="about.php">About Us</a></li>
											<li><a href="voluteers.php">Volunteers</a></li>
									</ul>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="woocommerce-billing-fields">
                                                                        ...
                                                                        <div class="woocommerce-billing-fields__field-wrapper">
                                                                            <div class="row">
																			  <form class="woocomerce-form woocommerce-form-login login" method="post" action="insertvolunteer.php" enctype="multipart/form-data">
																			  
                                                                                    <label>Please download  <a href="Attachments/VOLUTEERS REQIREMENTS.docx">this</a> attachent and read through it to get guided before applying</label> 
																					<p>Attachment:  <a href="Attachments/VOLUTEERS REQIREMENTS.docx">VOLUTEERS REQUIREMENTS download link</a> </p> 
                                                                            ...
                                                                            <p class="form-row form-row-last validate-required" id="billing_company_field" data-priority="20">
																			 ...
																			 <p class="form-row form-row-last validate-required" id="billing_country_field" data-priority="20">
																				...
																				<select name="addressContinent" name="continent">
                                                                            ...
                                                                            <p class="form-row form-row-last validate-required" id="billing_country_field" data-priority="20">
                                                                                  <label for="billing_address" class="">Country<abbr class="required" title="required">*</abbr></label>
                                                                    ...
                                                                    <div class="vk-checkout-order-paypal">
                                                                        <div id="order_review" class="woocommerce-checkout-review-order">
                                                                           ...
                                                                           <p class="form-row form-row-last validate-required" id="billing_address_field" data-priority="20">
																			...
																			<p class="form-row form-row-last2 validate-required" id="billing_town_city_field" data-priority="20">
                                                                                <label for="billing_town_city" class="">CV:<abbr class="required" title="required">*</abbr></label>
                                                                                <input type="file" style="vertical-align: middle;" name="cvs" id="cvs" required>
                                                                            </p>
																			<p class="form-row form-row-last2 validate-required" id="billing_town_city_field" data-priority="20">
                                                                                <label for="billing_town_city" class="">1st Recommendation:<abbr class="required" title="required">*</abbr></label>
                                                                                <input type="file" style="vertical-align: middle;" name="recommendation1" id="recommendation1" required>
                                                                            </p>
																			<p class="form-row form-row-last2 validate-required" id="billing_town_city_field" data-priority="20">
                                                                                <label for="billing_town_city" class="">2nd Recommendation:<abbr class="required" title="required">*</abbr></label>
                                                                                <input type="file" style="vertical-align: middle;" name="recommendation2" id="recommendation2" required>
                                                                            </p>
																				<p class="form-row form-row-last2 validate-required" id="billing_town_city_field" data-priority="20">
                                                                                <label for="billing_town_city" class="">NB:<abbr class="required" title="required"></abbr></label>
                                                                                  <label for="billing_town_city" class="">Please Complete this with The Email you registered when registering as a member. Else the Registration will be rejected.<abbr class="required" title="required"></abbr></label>
                                                                            </p>
                                                                            </div>
                                                                            ...
                                                                            <div id="payment" class="woocommerce-checkout-payment">
                                                                                ...
                                                                                <div class="form-row place-order">
                                                                                    ...
                                                                                    <input type="submit" class="button alt" name="place_order" id="place_order" value="REGISTER" data-value="Place order">
