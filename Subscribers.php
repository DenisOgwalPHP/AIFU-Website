																...
																<div class="vk-checkout-billing-left">
																	<div class="col-md-6">
																		<div class="woocommerce-billing-fields">
																			...
																			<div class="woocommerce-billing-fields__field-wrapper">
																				...
																				<p class="form-row form-row-last validate-required" id="billing_ordernote_field" data-priority="20">
																					<label class="">Subscription Notes</label>
																					<textarea class="input-text " name="notes" id="notes" placeholder=""></textarea>

																				</p>
																				<p class="form-row form-row-last validate-required" id="billing_country_field" data-priority="20">
																					<label for="billing_country" class="">Membership Type</label>
																					<select name="membershiptype" id="membershiptype" onchange="getpayableammount()" required>
																		...
																		<div class="vk-checkout-creat-account">
																			<h3>
																				<input id="payment_method" type="checkbox" class="input-radio checkbox-create-account" name="payment_method" value="cheque" data-order_button_text="">
																			...
																			<div class="vk-check-create-account-form checkbox-create-account-form">
																				...
																				<p class="form-row form-row-first">
																					...
																					<input type="password" class="input-text" name="passwords" id="passwords">
																				</p>
																				<div class="clearfix"></div>
																			...
																			<div id="order_review" class="woocommerce-checkout-review-order">
																				<div class="vk-checkout-order-left">
																					...
																					<table class="shop_table woocommerce-checkout-review-order-table">
																						<thead>
																							<tr>
																								<th class="product-name">Full membership:</th>
																							</tr>
																							<tr>
																								<td class="product-name" style="text-align:Center; text-align:justify;text-justify:inter-word;">
																							...
																							<tr>
																								<th class="product-name">Associate Membership:</th>
																							</tr>
																							<tr>
																								<td class="product-name" style="text-align:Center; text-align:justify;text-justify:inter-word;">
																							...
																							<tr>
																								<th class="product-name">Honorary Membership:</th>
																							</tr>
																							<tr>
																								<td class="product-name" style="text-align:Center; text-align:justify;text-justify:inter-word;">
																									An individual who has made unique, seminal contribution to the field of social work is eligible for election
																									to Honorary Membership. The number of Honorary Members cannot exceed one (1) in a calendar year. Under extraordinary circumstances, the Board of Directors may exceed the normal yearly limitation. Election required the unanimous vote of the Board of Directors.<br />
																									A Member of the Organization may nominate someone to the status of Honorary Membership by sending a brief (no longer than one page) advocacy statement discussion the candidate to the Chairman Board of Directors.

																								</td>
																							</tr>
																							<tr>
																								<th class="product-name">Trustees:</th>
																							</tr>
																							<tr>
																								<td class="product-name" style="text-align:Center; text-align:justify;text-justify:inter-word;">
																				...
																				<div id="payment" class="woocommerce-checkout-payment">
																					...
																					<ul class="wc_payment_methods payment_methods">
																						<li class="wc_payment_method payment_method_cheque">
																							<label for="payment_method_cheque">
																								<a href="Attachments/AIFU CONSTITUTION.pdf">AIFU Constitution Download Link</a></label><br />
																							<label for="payment_method_cheque">
																								Note This </label>
																							<div class="payment_box payment_method_cheque">
																								<p>The annual membership fee is 10,000/= for every individual member and 100,000/= for member organizations.</p>
																							</div>
																						</li>
																						<li>
																							<hr>
																					...
																					<Script type="text/javascript">
																						function getpayableammount() {
																							if (document.getElementById("membershiptype").value == "Organisation") {
																								Amount.value = (100000 / 3600).toFixed(0);
																							} else if (document.getElementById("membershiptype").value == "Individual") {
																								Amount.value = (10000 / 3600).toFixed(0);
																							}
																						}
																					</Script>
																					<p class="form-row form-row-last validate-required" id="billing_address_field" data-priority="20">
																						<label for="billing_address" class="">Amount Payable(USD)<abbr class="required" title="required">*</abbr></label>
																						<input type="number" class="input-text " name="Amount" id="Amount" placeholder=" Amount In USD" readonly>
																					</p>
																					<div class="form-row place-order" id="paypalbutton">
																						<!--<input type="submit" class="button alt" name="place_order" id="place_order" value="SUBSCRIBE" data-value="Place order">
		...
		style: {
			...
			onApprove: function(data, actions) {
				return actions.order.capture().then(function(details) {
					//window.location = "insertsubscription.php?orderID=" + data.orderID + "&email=" + document.getElementById("email").value + "&first_name=" + document.getElementById("first_name").value + "&last_name=" + document.getElementById("last_name").value+ "&region=" + document.getElementById("region").value + "&address=" + document.getElementById("address").value + "&postcode=" + document.getElementById("postcode").value+ "&amount=" + details.purchase_units[0].amount.value + "&country=" + document.getElementById("country").value+ "&town_city=" + document.getElementById("town_city").value+ "&notes=" + document.getElementById("notes").value+ "&phone=" + document.getElementById("phone").value+ "&company=" + document.getElementById("company").value + "&addressContinent=" + document.getElementById("addressContinent").value 
					window.location = "insertsubscription.php?orderID=" + data.orderID + "&email=" + document.getElementById("email").value + "&first_name=" + document.getElementById("first_name").value + "&last_name=" + document.getElementById("last_name").value + "&region=" + document.getElementById("region").value + "&address=" + document.getElementById("address").value + "&postcode=" + document.getElementById("postcode").value + "&Amount=" + details.purchase_units[0].amount.value + "&country=" + document.getElementById("country").value + "&town_city=" + document.getElementById("town_city").value + "&notes=" + document.getElementById("notes").value + "&phone=" + document.getElementById("phone").value + "&company=" + document.getElementById("company").value + "&addressContinent=" + document.getElementById("addressContinent").value + "&passwords="+ document.getElementById("passwords").value + "&membershiptype="+ document.getElementById("membershiptype").value + "&payment_method="+ document.getElementById("payment_method").value;
