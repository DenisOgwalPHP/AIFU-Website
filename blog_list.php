                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="uni-main-menu">
									...
									<li><a style="background:#3f97da;" href="blog_list.php">Blog</a></li>
									<li><a href="gallery.php">Gallery</a></li>
									<li><a href="contact.php">Contact</a></li>
									<li class="has-sub"><a href='#'>shop</a>
										<ul>
                            ...
                            <div class="col-md-8">
                                <div class="uni-blog-list-left">
												...
												if(isset($_GET['search']))
								   {
									   $search=$_GET['search'];						
									require_once('connect.php');
									$sales6 ="SELECT * FROM `blogs` where blogtitle like '%".$search."%' OR  blogshotdescription like '".$search."%' OR description like '".$search."%' OR Date like '".$search."%'  order by blogid Desc";
                                    ...
                                    echo"<div class='blog-list-item'>";
                                        echo"<article class='post type-post'>";
                                            echo"<div class='content-inner'>";
                                                echo"<div class='uni-entry-top'>";
                                                    echo"<div class='thumbnail-img'>";
                                                        echo"<a href='#' title=''>";
                                                            echo"<img src='images/blogimg/".$row5['blogimage']."' style='height:400px;width:100%;' alt='' title='' class='img-responsive'>";
                                                        echo"</a>";
                                                    echo"</div>";
                                                echo"</div>";


                                                echo"<div class='uni-entry-body'>";
                                                    echo"<div class='uni-entry-time'>";
                                                        echo"<ul>";
														$years=date("Y");
														$monthss=date("M");
														$dates=date("d");
                                                        ...
                                                        echo"</ul>";
                                                    echo"</div>";
                                                    echo"<div class='uni-entry-content'>";

                                                        echo"<header class='uni-entry-header'>";
                                                           echo" <h2 class='uni-entry-title'>";
                                                                echo"<a href='single_post.php?ids=".$row5['blogid']."' rel=''>".$row5['blogtitle']."</a>";
                                                            echo"</h2>";
                                                        echo"</header>";
                                                        echo"<div class='uni-entry-meta'>";
                                                        echo"<span class='uni-author'>";
                                                            echo"<a href='single_post.php?ids=".$row5['blogid']."' rel='author'><i class='fa fa-calendar' aria-hidden='true'></i> ".$row5['Date']."</a>";
                                                        echo"</span>";
                                                            echo"<span class='uni-comment-total'>";
                                                            echo"<a href='single_post.php?ids=".$row5['blogid']."' class='comments-link'><i class='fa fa-user' aria-hidden='true'></i> ".$row5['postedby']."</a>";
                                                        echo"</span>";
														$sales7 ="SELECT COUNT(Comment) as mynumber FROM `comments` where RepliedTo='".$row5['blogid']."'";
														$result8=mysqli_query($link,$sales7);
														if($row8=mysqli_fetch_assoc($result8)){
                                                            echo"<span class='uni-entry-folder'><a href='#'><i class='fa fa-comment' aria-hidden='true'></i>".$row8['mynumber']." comments</a></span>";
														}
														echo"</div>";
                                                        echo"<div class='uni-entry-summary'>";
                                                            echo"<p style='text-align:justify;text-justify: inter-word;'>".$row5['blogshotdescription']."</p>";
                                                        echo"</div>";
														if($_SESSION['aifuuser']=="Guest"){
														echo"<p style='text-align:justify;text-justify: inter-word; text-size:8px;'>Attachment:<a href='checkout.php'> Please Click here for login to download the attachment.</a></P>";
														}else{
														echo"<p style='text-align:justify;text-justify: inter-word;'>Attachment: <a href='images/blogattach/".$row5['attachment']."'>".$row5['attachment']."</a></p>";
														}
                                                        echo"<div class='readmore'>";
                                                            echo"<a href='single_post.php?ids=".$row5['blogid']."'><i class='icomoon icon-up'></i>Read More</a>";
                                                        echo"</div>";
                                                    echo"</div>";
                                                echo"</div>";
                                            echo"</div>";
								...
								else if(isset($_GET['realpage']))
								   {
									$realpage=$_GET['realpage'];
									if($realpage<=0){
										$realpage=1;
									}									
									require_once('connect.php');
									$sales6 ="SELECT * FROM(SELECT * FROM `blogs` order by blogid Desc LIMIT $realpage) as tb1  order by blogid Asc LIMIT 1";
									$result5=mysqli_query($link,$sales6);
									$counter1=1;
									while($row5=mysqli_fetch_assoc($result5)){
                                    echo"<div class='blog-list-item'>";
									...
									$realpages=$realpage+1;
									$realpagess=$realpage-1;
                                     echo"<div class='uni-divider'></div>";
                                     echo"<div class='uni-pagination-blog'>";
                                         echo"<ul>";
                                             echo"<li class='older-post'><a href='blog_list.php?realpage=".$realpagess."'><i class='fa fa-long-arrow-left' aria-hidden='true'></i> older post</a></li>";
                                             echo"<li class='newer-post'><a href='blog_list.php?realpage=".$realpages."'>newer post <i class='fa fa-long-arrow-right' aria-hidden='true'></i></a></li>";
                                         echo"</ul>";
                                     echo"</div>";									
								   }
							else{
										
								$sales7 ="SELECT COUNT(blogtitle) as mynumber FROM `blogs`";
								$result8=mysqli_query($link,$sales7);
								if($row8=mysqli_fetch_assoc($result8)){
								...
								if($numbers>5){
									...
									require_once('connect.php');
									$sales6 ="SELECT * FROM(SELECT * FROM `blogs` order by blogid Desc LIMIT $realpage) as tb1  order by blogid Asc LIMIT 5";
									$result5=mysqli_query($link,$sales6);
									$counter1=1;
									while($row5=mysqli_fetch_assoc($result5)){
                                    echo"<div class='blog-list-item'>";
                                    ...
                                    echo"</div>";
										...
										$realpages=$realpage+5;
										$realpagess=$realpage-5;
                                     echo"<div class='uni-divider'></div>";
                                     echo"<div class='uni-pagination-blog'>";
                                         echo"<ul>";
                                             echo"<li class='older-post'><a href='blog_list.php?realpage=".$realpagess."'><i class='fa fa-long-arrow-left' aria-hidden='true'></i> older post</a></li>";
									...
									require_once('connect.php');
									$sales6 ="SELECT * FROM `blogs` order by blogid Desc LIMIT 5";
									$result5=mysqli_query($link,$sales6);
									$counter1=1;
									while($row5=mysqli_fetch_assoc($result5)){
                                    echo"<div class='blog-list-item'>";
                                                ...
                                                <div class="uni-search-sidebar">
                                                    <form action="blog_list.php" method="get">
                                                        <div class="vk-newlist-banner-test-search">
                                                            ...
                                                            <button type="submit" name="searchbutton"><i class="fa fa-search" aria-hidden="true"></i></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <aside class="widget">
                                            ...
                                            <div class="widget-content">
                                                <div class="uni-widget-popular-posts">
													...
													<?php
													require_once('connect.php');
													$sales6 ="SELECT blogtitle,description,attachment,blogimage,blogid,blogshotdescription,Date,postedby FROM `blogs` order by blogid Desc LIMIT 5";
													$result5=mysqli_query($link,$sales6);
													$counter1=1;
													while($row5=mysqli_fetch_assoc($result5)){
                                                         echo"<li>";
								...
								<div class="widget-content">
									<div class="uni-footer-latest-post">
										...
										<?php
											...
											while($row5=mysqli_fetch_assoc($result5)){
											echo"<li>";
												echo"<h4 style='text-align: justify;text-justify: inter-word'><a href='#'>".$row5['blogtitle']."</a></h4>";
