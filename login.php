...
// getting inputs from the form		
	...
	require_once('connect.php');
			...
			if( $fetchedpassword ==$encryptedpassword){
				$sales11 ="UPDATE carttemporary SET User='".$email."' where User='".$_SESSION['aifuemail']."'";
				...
				$_SESSION['aifuuser']=$staffnames;
				$_SESSION['aifuemail']=$email;
				$_SESSION['aifuTelephone']=$tele;
